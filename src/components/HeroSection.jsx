      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col-reverse lg:flex-row items-center justify-between">
        ...
        <div className="lg:w-1/2 lg:pr-12 mb-8 lg:mb-0">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            ...
            ক্ষেত্রে শিক্ষা, স্বাস্থ্য, আবাসন ও জীবনমান উন্নয়নে ব্যাপক কর্মসূচী
            পরিচালনা করে। আমরা শিক্ষার্থীদের বৃত্তি প্রদান, অসুস্থদের চিকিৎসা
            নিশ্চিতকরণ, গৃহহীনদের আশ্রয় প্রদান, গ্রামীণ এলাকার যোগাযোগ ব্যবস্থা
            উন্নয়ন, পরিবেশ সুরক্ষা, বাল্যবিবাহ প্রতিরোধ, দারিদ্র্য বিমোচন ও
            রক্তদানের মতো কার্যক্রমের মাধ্যমে একটি সুন্দর ও সুস্থ সমাজ গঠনে
